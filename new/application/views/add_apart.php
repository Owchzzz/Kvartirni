<script type="text/javascript">
    ...
    function addNum(){
        ...
        if(TotalNums < 2){
        newcont="<div id=\""+TotalNums+"\"><input type=\"hidden\" name=\"maincallaffter\" value=\""+caft+"\"/><input type=\"hidden\" name=\"maintelnum\" value=\""+num+"\"/><br clear=\"left\"><label class=\"lab_dobav_3\">Main</label><label class=\"lab_dobav_2\">"+num+"</label><a href=\"javascript:;\" onClick=\"delNumMain('#"+TotalNums+"');\" class=\"del_phone\" >Delete Number</a> </div><br clear=\"left\"><br>";
        }
        else{
        newcont="<div id=\""+TotalNums+"\"><input type=\"hidden\" name=\"callafter"+TotalNums+"\" value=\""+caft+"\" /><input type=\"hidden\" name=\"telnum"+TotalNums+"\" value=\""+num+"\" /><br clear=\"left\"><label class=\"lab_dobav_3\">Additional</label><label class=\"lab_dobav_2\">"+num+"</label><a href=\"javascript:;\" onClick=\"delNum('#"+TotalNums+"');\" class=\"del_phone\" >Delete Number</a> </div><br clear=\"left\"><br> ";
        }
        TotalNums++;
...
<form action="/new/aparts/savenew/" method="post" class="form_dobav" enctype="multipart/form-data">
    <div class="div_check">
    ...
    <input type="checkbox" class="styled" name="cb_icq" value="1"/><label class="lab_dobav_1">ICQ</label>
    <input type="checkbox" class="styled" name="cb_skype" value="1"/><label class="lab_dobav_1">Skype</label>
    </div>
    <label><?php echo lang('your_name'); ?> *</label><input type="text" value="" name="OwnerName" id="OwnerName"/>
    ...
    <div class="div_raspolog">
     <label><?php echo lang('country'); ?>*</label>
            ...
            <label><?php echo lang('district'); ?></label><input type="text" name="district" class="inp_dob_3" />
            <p class="cmall"><?php echo lang('shortly_25'); ?>.</p>
             <label><?php echo lang('address'); ?></label><input type="text" name="address" class="inp_dob_3" />
...
<iframe width="575" height="300" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com/maps?f=q&amp;source=s_q&amp;hl=ru&amp;q=%D0%9E%D0%B1%D0%BD%D0%B8%D0%BD%D1%81%D0%BA,+%D0%B3%D0%BE%D1%80%D0%BE%D0%B4+%D0%9E%D0%B1%D0%BD%D0%B8%D0%BD%D1%81%D0%BA,+%D0%9A%D0%B0%D0%BB%D1%83%D0%B6%D1%81%D0%BA%D0%B0%D1%8F+%D0%BE%D0%B1%D0%BB%D0%B0%D1%81%D1%82%D1%8C,+%D0%A0%D0%BE%D1%81%D1%81%D0%B8%D1%8F&amp;sll=40.277762,-96.804094&amp;sspn=35.555607,82.529297&amp;ie=UTF8&amp;geocode=FSCfSAMdLKcuAg&amp;split=0&amp;hq=&amp;hnear=%D0%9E%D0%B1%D0%BD%D0%B8%D0%BD%D1%81%D0%BA,+%D0%B3%D0%BE%D1%80%D0%BE%D0%B4+%D0%9E%D0%B1%D0%BD%D0%B8%D0%BD%D1%81%D0%BA,+%D0%9A%D0%B0%D0%BB%D1%83%D0%B6%D1%81%D0%BA%D0%B0%D1%8F+%D0%BE%D0%B1%D0%BB%D0%B0%D1%81%D1%82%D1%8C,+%D0%A0%D0%BE%D1%81%D1%81%D0%B8%D1%8F&amp;t=m&amp;z=12&amp;ll=55.090976,36.611884&amp;output=embed"></iframe>
	...
	<ul class="ul_char">
	<li><label><?php echo lang('number_rooms'); ?></label><input type="text" name="numrooms" value=""/></li>
	<li><label><?php echo lang('area_apartment'); ?></label><input type="text" name="area"  value="" /><span>м&sup2;</span></li>
	<li><label><?php echo lang('floor_floors'); ?></label><input type="text" name="floor"  value="" /><span>/</span><input type="text" name="totalfloors"  value="" /></li>
	<li><label><?php echo lang('sleeps'); ?></label><input type="text" name="sleeps" value="" /></li>
	</ul>
	<p class="small_1"><?php echo lang('currency'); ?></p>
	  ...
	  <label class="lab_dobav_5"><?php echo lang('day'); ?> *</label><input type="text" name="day" class="inp_dob_4" value="" /><label class="lab_dobav_5"><?php echo lang('night'); ?></label><input type="text" name="night" class="inp_dob_4" value="" />
	  <label class="lab_dobav_5"><?php echo lang('hour'); ?></label><input type="text" name="hour" class="inp_dob_4" value="" />
	  <br clear="left" />
	  <p>Включено в цену:</p>
	  <label class="lab_dobav_7">размещение не более</label><input type="text" class="inp_dob_5" name="maxpeople" value="" /> <label class="lab_dobav_6"><?php echo lang('people'); ?></label>
	  <label class="lab_dobav_7"><?php echo lang('minimum_order'); ?></label><input type="text" name="minorders" class="inp_dob_5" value="" /><label class="lab_dobav_6"><?php echo lang('hours'); ?></label>
	  <br clear="left" />
	...
	<div class="div_check_1">  <label class="lab_dobav_7"><?php echo lang('balcony'); ?></label><input type="checkbox" name="balcony" class="styled" value="1"/><label class="lab_dobav_8"><?php echo lang('yes'); ?></label>
	  </div>
	  <br clear="left" />
	  <h2><?php echo lang('equipment_services'); ?></h2>
	  <div class="div_usl">
	  <input type="checkbox" class="styled" name="tv" value="1"/><label><?php echo lang('tv'); ?></label>
	  <input type="checkbox" class="styled" name="internet" value="1" /><label><?php echo lang('internet'); ?></label>
	  <input type="checkbox" class="styled" name="air_con" value="1"/><label><?php echo lang('air_conditioning'); ?></label>
	  <input type="checkbox" class="styled" name="refrigerator" value="1"/><label><?php echo lang('refrigerator'); ?></label>
	  <input type="checkbox" class="styled" name="stove" value="1"/><label><?php echo lang('stove'); ?></label>

	  </div>
	    <div class="div_usl">
	  <input type="checkbox" class="styled" name="microwave" value="1"/><label><?php echo lang('microwave_oven'); ?></label>
	  <input type="checkbox" class="styled" name="washing" value="1"/><label><?php echo lang('washing_machine'); ?></label>
	  <input type="checkbox" class="styled" name="phoneavailable" value="1"/><label><?php echo lang('phone'); ?></label>
	  <input type="checkbox" class="styled" name="bath" value="1"/><label><?php echo lang('bath_shower_bath'); ?></label>
	  <input type="checkbox" class="styled" name="parking" value="1"/><label><?php echo lang('parking'); ?></label>

	  </div>
	  <div class="fL">
	  <input type="checkbox" class="styled" name="booking" />
...
снимите эту галочку.</span>
	  ...
	  <textarea name="conditions_order" cols="" rows=""></textarea>
...
2) <?php echo lang('discounts'); ?></p>
 <p><?php echo lang('conditions_of_accommodation'); ?> </p>
	  <textarea name="conditions_accom" cols="" rows=""></textarea>
